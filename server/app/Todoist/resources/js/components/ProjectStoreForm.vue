<template>
  <div class="project-form">
    <div class="border-bottom font-large form-title p-3">プロジェクトを追加</div>
    <div class="p-3">
      <div class="mx-auto">
      ...
      <div class="mt-3 mx-auto">
        ...
        <div class="p-relative">
          <div class="color-input input p-2" @click="colorPicker = true">
            <div v-if="selectedColor" class="align-items-center d-flex h-100">
              <ColorSample :color="selectedColor.hex" :size="16"></ColorSample>
      ...
      <div class="d-flex mt-3">
        <span class="border button ml-auto" @click="$emit('cancel')">キャンセル</span>
